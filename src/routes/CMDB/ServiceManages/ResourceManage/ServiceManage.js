...
import SystemConfig from './serviceManage/SystematicConfig';
...
@connect((state) => {
  return {
    ...
    operateAuthor: state.serviceManage.operateAuthor,
  };
})
@Form.create({
...
export default class ServiceManage extends PureComponent {
  ...
  render() {
    ...
    // console.log('operateAuthor-公有云', operateAuthor);
    const columns = [{
      title: '序号',
      key: 'id',
