...
@connect((state) => {
  return {
    errorModalStatus: state.physicalmanage.errorModalStatus,
    errorInfo: state.physicalmanage.errorInfo,
  };
})
...
export default class ErrorModal extends Component {
    hiddenErr = (item) => {
      ...
      dispatch({
        type: 'physicalmanage/saveErrorModalStatus',
        payload: {
          show: false,
          loading: false,
        },
      ...
      dispatch({
        type: 'physicalmanage/saveErrorInfo',
        payload: {
          exceptiontime: '', // 异常时间
